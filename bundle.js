...
gui.add( myGrid, 'step', 0.0, 10.00 );   // Number Field
...
const gridPlane = new PlaneGeometry( Grddsz, Grddsz, Griddivisions, Griddivisions );
...
const plane = new Mesh( gridPlane, gridPlaneMaterial );
plane.renderOrder = 2;
scene.add( plane );


const axesHelper = new AxesHelper( Gridsize*10.0 );
